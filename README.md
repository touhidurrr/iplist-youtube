...
Personally recommend running the scripts at least **7324** times at the interval of **5** minutes or **300** seconds (Google's TTL).
For reasonable performance, run it **7324** times before using it for production.
